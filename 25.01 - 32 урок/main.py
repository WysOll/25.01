...
u1=User("Alexey","Kosenko",14,"Ukraine",2016)
u1.describe_user()
u1.greet_user()
u2=User("Khaby","Lame",14,"USA",2020)
u2.describe_user()
u2.greet_user()
u3=User("Den","Dmitriev",23,"Kazahstan",2005)
u3.describe_user()
u3.greet_user()
#Rectangle
print("")
...
r1.number_served=12
print(r1.number_served)
number_served=int(input("How many people have you served?:"))
r1.set_number_served(number_served)
print(r1.number_served)
while True:
    time=float(input("For how many hours are you interested in the quantity?:"))
    if time<=0:
...
class Admin(User):
    ...
    def show_privileges(self):
        for i in self.privileges:
            print(f"You can {i}")
u1=Admin("Alexey","Kosenko",14,"Ukraine",2016,["ban other users","kick other users","mute other users"])
u1.show_privileges()
#9.8
print("")
print(9.8)
...
a1=Admin("Alexey","Kosenko",14,"Ukraine",2016,["Allowed to add","Allowed to delete users","Allowed to ban users"])
...
u2=Admin("Alexey","Kosenko",14,"Ukraine",2016)
u2.show_privileges()
#                                       9.10
...
r1=Restaurant("Comfy","electronical")
r1.describe_restaurant()
#                                       9.11
print("")
print("9.11")
from User_Admin_Privileges import *
u1=Admin("Alexey","Kosenko",14,"Ukraine",2016)
u1.show_privileges()
#                                       9.12
print("")
print("9.12")
